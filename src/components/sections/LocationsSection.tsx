      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-300 max-w-2xl mx-auto">
            Ознайомтеся з розташуванням наших LED-екранів у різних містах України. Обирайте найближчу локацію для вашої рекламної кампанії.
          </p>
        </div>
        ...
        {currentCity && currentCity.isComingSoon && (
          <div className="bg-[#1a2330] rounded-xl p-10 text-center">
            ...
            <p className="text-gray-400 max-w-lg mx-auto">
              Ми готуємося до запуску LED-екранів у цьому місті. Залиште свої контактні дані, щоб першими дізнатися про нові локації.
            </p>
            <Link 
              href="#контакти" 
